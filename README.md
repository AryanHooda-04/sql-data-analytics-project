...
## 📌 Project Overview
This repository contains a comprehensive set of SQL scripts designed for data exploration, cleaning, and advanced business analytics. The goal of this project is to transform raw data into actionable insights using structured query language.
...
* Execute the contents of `Scripts/schema_setup.sql` to build the environment.

3. **Load Data**
* Import the datasets found in the `Data/` directory into their respective tables.

## 📊 Usage
To view the results of the analysis, run the queries located in: `Scripts/analysis_queries.sql`
